...
public class TestEmbeddingDMatrixGenerator {
    ...
    public void testNormalizedMatrixGeneration() {
        ...
        float[][] trueMatrix = TestUtils.matrixSum(TestUtils.outerProduct(TestUtils.normalizeVector(
                ...
                TestUtils.matrixScalarProduct(2.0f,
                        TestUtils.outerProduct(
                                TestUtils.normalizeVector(TestUtils.vectorSum(TestUtils.vectorScalarProduct(2.0f, beta),
        ...
        trueMatrix = TestUtils.matrixSum(
                TestUtils.outerProduct(TestUtils.normalizeVector(
                        TestUtils.vectorSum(
                                TestUtils.vectorScalarProduct(2.0f, beta),
                                TestUtils.vectorScalarProduct(3.0f, gamma)))),
                TestUtils.matrixScalarProduct(2.0f, TestUtils.outerProduct(TestUtils.normalizeVector(
